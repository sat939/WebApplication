...
public class CustomerServiceLocator extends org.apache.axis.client.Service implements org.example.www.customer.CustomerService {
 ...
 */
    ...
    private java.lang.String Service_address = "http://sathviklaptop:8080/customerService";
    ...
    public org.example.www.customer.Customer_PortType getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.example.www.customer.Customer_BindingStub _stub = new org.example.www.customer.Customer_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.example.www.customer.Customer_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.example.www.customer.Customer_BindingStub _stub = new org.example.www.customer.Customer_BindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.example.org/customer", "CustomerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.example.org/customer", "Service"));
        }
